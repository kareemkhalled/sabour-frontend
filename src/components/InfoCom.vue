<template>
    <div class="info-barr" style="color: white; text-align:center;; font-size: .6vi; font-weight: 600;">

        <!-- <span style="position: relative; right: -5vi;">{{ temperature }}°C</span> -->

        📅<span style="position: relative; ">{{ currentDate }}</span>  

      <!-- ⏳<div style="display: flex; justify-content: space-between;"> -->
                <!-- <span>{{ weather }}</span>  -->
                <span style="position: relative;right: -3.8vi; color: ; ">{{ currentTime }}</span> ⏳
