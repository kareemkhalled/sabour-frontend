    ...
    <div class="gauge-container">
      ...
      >
        <defs>
          ...
          <stop offset="0%" stop-color="#ffcc00" /> <!-- Bright Yellow -->
          <stop offset="80%" stop-color="#ff6600" /> <!-- Orange -->
          <stop offset="100%" stop-color="#cc0000" /> <!-- Deep Red -->
        </linearGradient>
        </defs>
        <!-- Gauge Arc -->
        <path
...
export default {
  ...
  animateNeedle(targetValue) {
    ...
    mounted() {
      const values = [0, 4000, 8000, 12000,16000];
